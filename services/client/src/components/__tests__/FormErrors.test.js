...
it('FormErrors (with register form) renders properly', () => {
...
it('FormErrors (with register form) renders a snapshot properly', () => {
...
it('FormErrors (with login form) renders properly', () => {
...
it('FormErrors (with login form) renders a snapshot properly', () => {
  const tree = renderer.create(
